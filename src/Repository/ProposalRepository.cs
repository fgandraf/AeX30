        ...
        public Proposal GetProposal(string filePath)
        {
            try
            {
                ...
                Proposal proposal = new Proposal
                {
                    ...
                    ImovelValorTerreno = FormatString.ValorMonetário(sheet.GetRow(new CellReference(cellReference[16]).Row).GetCell(new CellReference(cellReference[16]).Col).NumericCellValue.ToString()),
